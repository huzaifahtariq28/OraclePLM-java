...
/**
 * Servlet implementation class EditBOM
 */
@WebServlet("/EditBOM")
public class EditBOM extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		final String UPDATE_BOM_SQL = "UPDATE bom SET bomName=?, bomDescription=? WHERE bomId = ?";
		...
		try {
			...
			preparedStatement = db.prepareStatement(UPDATE_BOM_SQL);
		
			preparedStatement.setString(1, req.get("bomName").toString());
            preparedStatement.setString(2, req.get("bomDescription").toString());
            preparedStatement.setLong(3, (long) req.get("bomId"));
