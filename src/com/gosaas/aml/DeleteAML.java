...
/**
 * Servlet implementation class DeleteAML
 */
@WebServlet("/DeleteAML")
public class DeleteAML extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		final String DELETE_AML_SQL = "DELETE FROM aml WHERE amlId = ?";
		...
		try {
			...
			preparedStatement = db.prepareStatement(DELETE_AML_SQL);
		
            preparedStatement.setLong(1, (long) req.get("amlId"));
